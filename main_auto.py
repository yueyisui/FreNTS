...
def train(args):
    ...
    INPUT_FILE = args.data_folder + '/' + args.image_name
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', default="data/images_compared_1", type=str, help='data folder')
    ...
    parser.add_argument('--lambda_occ', type=float, default=0.05, help='lambda of occ') # 0.05
    ...
    path_names = os.listdir(args.input_dir)
    path_names = sorted(path_names)[0:1]
    for path_name in path_names:
        input_image_dir = os.path.join(args.input_dir, path_name)
        output_image_dir = os.path.join(args.output_folder, path_name)
        ...
        for image_name in image_names:
            ...
            args.data_folder = input_image_dir
            args.output_folder = output_image_path
            args.output_name = image_name
            train(args)
